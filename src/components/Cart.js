...
export default function Cart({ removeproduct }) {
  ...
  const buynow = (total) => {
    if (loginuserData.firstname == "") {
      ...
      axios
        .post(`${process.env.REACT_APP_SURL}/order`, { total: total })
        .then((info) => {
          //console.log(total)
          //console.log(info)
          var options = {
            ...
            image:
              "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTVfBDn4_cYMz-d-b3Wr4cxXNkMkjwzws27Ug&usqp=CAU",
  ...
  return (
    <div>
      ...
      <div className="container-fluid mt-5">
        <Link to="/">
          <button className="btn btn-outline-primary btn-sm mt-4">back</button>
        </Link>
          ...
          <div className="main">
            {loginuserData.cart_item &&
              loginuserData.cart_item.map((x) => {
                return (
                  <div className="card m-2 p-4" key={x.id}>
                    <div className="row">
                      <div className="col-6">
                      ...
                      <div className="col-6">
                        ...
                        <button
                          ...
                          onClick={() =>
                            dispatch(increase_quantity(x.id, loginuserData._id))
                          }
                        >
                          +
                        </button>
                        ...
                        {x.quantity === 1 ? (
                          ...
                          <button
                            ...
                            onClick={() =>
                              dispatch(
                                decrease_quantity(x.id, loginuserData._id)
                              )
                            }
                          >
                            -
                        ...
                        <button
                          ...
                          onClick={() =>
                            dispatch(remove_product(x.id, loginuserData._id))
                          }
                        >
                          remove
                        </button>
